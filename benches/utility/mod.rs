...
pub fn bench_trips(c: &mut Criterion, groupname: &str, alg: fn(&UndirectedGraph<u64>, usize, usize) -> PathResult<u64>) {
...
pub fn read_input(path: &str) -> (UndirectedGraph<u64>, usize, usize) {
