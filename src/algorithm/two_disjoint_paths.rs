...
pub fn two_disjoint_paths<W: Weight>(graph: &UndirectedGraph<W>, (s1, t1): (usize, usize), (s2, t2): (usize, usize)) -> Option<(W, Vec<usize>, Vec<usize>)> {
    let mut g = graph.clone();
    g.remove_edge(&(t1,t2));
    unsafe {
        g.add_directed_edge(t1,(0.into(), t2));
    }
